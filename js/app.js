...
const I18N = {
  ru: {
    strings: {
      ...
      authorHint: 'Сделал(а) это приложение — буду рад(а) отзыву или просто привету.',
      authorVkBtn: '💬 Написать ВКонтакте',
      authorEmailBtn: '✉️ vysockiy.mark98@mail.ru',
  ...
  en: {
    strings: {
      ...
      authorHint: "Made this app — I'd love to hear your feedback, or just say hi.",
      authorVkBtn: '💬 Message on VK',
      authorEmailBtn: '✉️ vysockiy.mark98@mail.ru',
